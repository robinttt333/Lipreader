...
class TemporalCNN(nn.Module):
    def __init__(self,paramsDecoder):
        ...
        self.pool1 = nn.MaxPool1d(paramsDecoder["max_pool1_kernel"], paramsDecoder["max_pool1_stride"])
        ...
        self.linear = nn.Linear(4*paramsDecoder["bn_size"], paramsDecoder["bn_size"])
    ...
    def forward(self, input):
        ...
        """BatchNorm1d requires more than 1 as 0th element but we are passing
            [1,256] which gives error.So we comment it out for now"""
